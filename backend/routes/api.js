...
router.post('/isolir/devices/:id/setup-ip', authenticate, demoGuard, (r,s) => IsolirCtrl.setupIp(r,s));
router.get('/isolir/devices/:id/isolir-ip', authenticate, demoGuard, (r,s) => IsolirCtrl.inspectIp(r,s));
