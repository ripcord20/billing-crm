...
async function run(db) {
  ...
  await addColumn(sequelize, 'tenants', 'company_name', 'company_name VARCHAR(150) NULL');
  await addColumn(sequelize, 'tenants', 'owner_user_id', 'owner_user_id INT NULL');
  await addColumn(sequelize, 'tenants', 'radius_server_id', 'radius_server_id INT NULL');
